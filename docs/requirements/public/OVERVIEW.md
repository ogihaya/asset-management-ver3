...
| 7 | 毎月投資額の計算と配分 | 現在月から将来各月までの累積収入・累積支出を算出し、余力資産 = 累積収入 - 累積支出 - 生活防衛資金（固定金額入力）として投資可能額を計算する。投資可能額が0未満の場合は0円として扱う。投資先や投資比率はユーザー自由登録とし、配分比率は合計100%必須とする。 | Must |
...
| 8 | 可視化 | 総資産推移・口座推移・収支推移を折れ線グラフで可視化し、投資先割合を円グラフで可視化する。 | Must |
